  		...
  		"<div class='row'>"+
						  			...
						  			"<div class='col-sm-6'>"+
										  ...
										  "<div class='form-group row'>"+
										    ...
										    "<div class ='col-sm-8'>  <input name='state' type='text' class='form-control' ></div>"+
										  "</div>"+

										  "<div class='form-group row'>"+
										    "<label class='col-sm-2 form-control-label'>Phone:</label>"+
										    "<div class ='col-sm-8'>   <input name='phone' type='text' class='form-control'></div>"+
										    "</div>"+

										    "<div class='form-group row'>"+
										      "<label class='col-sm-2 form-control-label'>Email:</label>"+
										    "<div class ='col-sm-8'>   <input name='email' type='text' class='form-control' ></div>"+
										  "</div>"+
								"</div>"+	  
							...
							"<div class='col-sm-6'>"+
							    ...
							    "<div class ='col-sm-8'>  <input name='accountnumber' type='text' class='form-control' ></div>"+
							    "</div>"+

							    "<div class='form-group row'>"+
							     "<label class='col-sm-2 form-control-label'>Name:</label>"+
							    "<div class ='col-sm-8'> <input name='petname' type='text' class='form-control' ></div>"+
							    "</div>"+

							    "<div class='form-group row'>"+
							     "<label class='col-sm-2 form-control-label'>Breed:</label>"+
							     "<div class ='col-sm-8'>  <input name='breed' type='text' class='form-control' ></div>"+
							    "</div>"+

							    "<div class='form-group row'>"+
							    "<label class='col-sm-2 form-control-label'>Age:</label>"+
							     "<div class ='col-sm-8'> <input name='age' type='text' class='form-control'></div>"+
							     "</div>"+
							     "<div class='form-group row'>"+
							      "<label class='col-sm-2 form-control-label'>Gender:</label>"+
							     "<div class ='col-sm-8'> <input name='gender' type='text' class='form-control'></div>"+
							  "</div>"+
 	 ...
 	 "<div class='row'>"+
			...
			"</label></div>"+
				  ...
				  "<div class='form-group row'>"+
				   " <label class='col-sm-4 form-control-label'>Total amount claimed:</label>"+
				     "<div class ='col-sm-8'> <input name='amountclaimed' type='text' class='form-control'></div>"+
				  "</div>"+

				  "<div class='form-group row'>"+
				    "<label class='col-sm-4 form-control-label'>Date illness/injury first occurred:</label>"+
				    "<div class ='col-sm-8'>  <input name='dateofoccurrence' type='text' class='form-control'></div>"+
				  "</div>"+
		...
		"<div class='col-sm-6'>"+
		    ...
		    "<label class='col-sm-2 form-control-label'>Veterinarian:</label>"+
		    		    "<div class ='col-sm-8'>  <input name='vetname' type='text' class='form-control'>"+
		    		    	"</div>"+
		  	"</div>"+

		  	"<div class='form-group row'>"+
		    "<label class='col-sm-2 form-control-label'>Clinic name:</label>"+
		    "<div class ='col-sm-8'>  <input name='clinicname' type='text' class='form-control'></div>"+
		    "</div>"+

		    "<div class='form-group row'>"+
		     "<label class='col-sm-2 form-control-label'>Phone:</label>"+
		     "<div class ='col-sm-8'> <input name='vetphone' type='text' class='form-control'></div>"+
		    "</div>"+

		    "<div class='form-group row'>"+
		     "<label class='col-sm-2 form-control-label'>Fax:</label>"+
		     "<div class ='col-sm-8'>  <input name='fax' type='text' class='form-control'></div>"+
		    "</div>"+
 	  ...
 	  "<img src='three.PNG' width='1208' >"+
		...
		"<div class='row'>"+
  			...
  			"<div class='col-sm-6'>"+
				    ...
				    "<div class ='col-sm-8'> <input name='signature' type='text' class='form-control'></div>	"+
				  	"</div>"+
				  	"</div>"+
				    ...
				    "<div class ='col-sm-4'> <input name='date' type='text' class='form-control'></div>"+	
				  	"</div>"+
				  	"</div>"+
...
public void doPost(HttpServletRequest request,
 ...
 throws ServletException, IOException {
	...
	PrintWriter out = response.getWriter();
		...
		out.println("<html>");
		out.println("<head>");
		out.println("<title>Web Tools: Assignment 1 Part 6</title>");
		out.println("</head>");
		out.println("<body>");
